# Generated by Django 2.2.1 on 2019-05-13 10:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sats_api.Family')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sats_api.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sats_api.Product')),
            ],
        ),
    ]
